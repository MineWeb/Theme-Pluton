      ...
      <div class="modal-body">
        <?php if($isConnected AND $Permissions->can('CREDIT_ACCOUNT')) { ?>
          <?php if(!empty($starpass_offers)) { ?>
            <a class="btn btn-lg btn-info btn-block" data-toggle="collapse" href="#starpass" aria-expanded="false" aria-controls="starpass">StarPass</a>
            <br>
          ...
          <?php if(!empty($dedipass)) { ?>
            <a class="btn btn-lg btn-info btn-block" href="<?= $this->Html->url(array('controller' => 'payment', 'action' => 'dedipass')) ?>">Dedipass</a><br>
          <?php } ?>
          <?php if(!empty($paypal_offers)) { ?>
            <a class="btn btn-lg btn-info btn-block" data-toggle="collapse" href="#PayPal" aria-expanded="false" aria-controls="PayPal">PayPal</a>
            <br>
          ...
          <?php if($paysafecard_enabled) { ?>
            <a class="btn btn-lg btn-info btn-block" data-toggle="collapse" href="#PaySafeCard" aria-expanded="false" aria-controls="PaySafeCard">PaySafeCard</a>
            <br>
