...
<div id="content">
  <div class="container shop">
      <h1 class="title theme-color-underline white">Boutique</h1>
    <?= $this->element('flash') ?>
              ...
              echo '<div class="col-md-4 col-sm-6">';
                echo '<div class="product">';
                  ...
                  echo '<div class="shop-item-text">';
                    echo '<a href="#" class="display-item color" data-item-id="'.$item['id'].'"><p class="shop-item-text-price">'.$item['name'].' - '.$item['price'].' '.$Configuration->getMoneyName().'</p></a>';
                    echo '<p class="shop-item-text-btn">';
                      echo '<h3><a href="#" class="theme-color-btn block display-item color" data-item-id="'.$item['id'].'">'.$Lang->get('SHOP__BUY').'</a></h3>';
                    echo '</p>';
                  echo '</div>';
    ...
    <div class="col-sm-3">
        ...
        <div class="panel-heading" id="shop-panel">
      ...
      <div class="panel panel-default sidebar-menu">
        ...
        <div class="panel-body">
          <ul class="nav nav-pills nav-stacked category-menu">
            ...
            foreach ($search_categories as $category_link) {
              ...
              echo '<li';
                echo (isset($category) && $category_link['Category']['id'] == $category || (!isset($category) && $i == 1)) ? ' id="active"' : '';
              echo '>';
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
              <?php if($isConnected) { ?>
                <a href="#" data-toggle="modal" data-target="#cart-modal" class="theme-color-btn block color"><?= $Lang->get('SHOP__BUY_CART') ?></a>
              <?php } ?>
            </div>
          </div>
        <?php } ?>
