    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="col-xs-12">
                    <ul class="nav nav-pills nav-justified thumbnail setup-panel">
                        <li  class="black active">
                            <a href="#step-1">
                                <h4 class="list-group-item-heading white"><?= $Lang->get('VOTE__STEP_TITLE') ?> 1</h4>
                                <p class="list-group-item-text white"><?= $Lang->get('VOTE__STEP_SET_USER') ?></p>
                            </a>
                        </li>
                        <li class="disabled">
                            <a href="#step-2">
                                <h4 class="list-group-item-heading white"><?= $Lang->get('VOTE__STEP_TITLE') ?> 2</h4>
                                <p class="list-group-item-text white"><?= $Lang->get('VOTE__STEP_SET_WEBSITE') ?></p>
                            </a>
                        </li>
                        <li class="disabled">
                            <a href="#step-3">
                                <h4 class="list-group-item-heading white"><?= $Lang->get('VOTE__STEP_TITLE') ?> 3</h4>
                                <p class="list-group-item-text white"><?= $Lang->get('VOTE__STEP_GET_REWARDS') ?></p>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row step active" id="step-1">
                <div class="col-xs-12">
                    <div class="col-md-12 well setup-content text-center" id="vote-well">
            ...
            <div class="row step" id="step-2">
                <div class="col-xs-12">
                    <div class="col-md-12 well setup-content" id="vote-well">
                        <div class="loader">
                            <p>
        ...
        <div class="col-md-12" id="vote-well">

            <hr>

            <div class="well" id="vote-well">
